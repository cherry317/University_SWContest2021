...
<li><b> 확률분포 기반 토픽 재할당</b></li>
  ...
  <li><b> 같은 문서 내 단어의 토픽 분포 비교</b></li>
    ...
    - 첫 번째로, 단어가 속한 문서의 다른 단어들이 어떤 토픽에 할당되었는지 확인한다.<br>
  ...
  <li><b> 타 문서 내 단어의 토픽 분포 비교</b></li>
    - 두 번째로, 재할당하려는 단어 '배'가 다른 문서까지 포함한 전체 문서에서 어떤 토픽에 할당되었는지 확인한다.<br>
...
__LDA 토픽 모델링 결과, 문서별 토픽 분포와 토픽별 단어 분포를 얻을 수 있다.
